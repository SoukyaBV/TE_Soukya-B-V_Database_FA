...
--Creating Table Hospital for Joins
create table TE_FA_J_Hospital(
...
select * from TE_FA_J_Hospital

-- Creating Table Doctor for Joins
create table TE_FA_J_Doctor(
...
insert into TE_FA_J_Doctor
values(101,'Shyam','Diabetologist','4045907068',1),
...
select * from TE_FA_J_Doctor

--Creating Table Patient for Joins
create table TE_FA_JPatient
(
...
insert into TE_FA_J_Doctor
values(112,'Rajath','Ophthalmologist','4796722823',3)
insert into TE_FA_JPatient
...
select * from TE_FA_JPatient


--Patient Details(Inner Join)--
select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization from TE_FA_JPatient as P 
inner join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID 

--Patient, Doctor, Hospital Details(Inner Join)--
...
--Patient, All Doctors, Hospital Details(Full Join)--
select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization,H.Hos_ID,H.Hos_Name,H.Hos_Phone from TE_FA_JPatient as P 
full join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID full join TE_FA_J_Hospital as H on P.Hos_ID = H.Hos_ID

select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization,H.Hos_ID,H.Hos_Name,H.Hos_Phone from TE_FA_JPatient as P 
full join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID full join TE_FA_J_Hospital as H on D.Hos_ID = H.Hos_ID
...
full join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID 

select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization,H.Hos_ID,H.Hos_Name,H.Hos_Phone,H.Hos_City from TE_FA_JPatient as P 
full join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID full join TE_FA_J_Hospital as H on P.Hos_ID = H.Hos_ID


--All Doctors Details(Right Join)--
select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization from TE_FA_JPatient as P 
right join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID 

select Doc_ID,Doc_Name  from TE_FA_J_Doctor

--Patient,Doctor and Hospital Details for Doctors who treat patients--
select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization,H.Hos_ID,H.Hos_Name,H.Hos_Phone,H.Hos_City from TE_FA_JPatient as P 
right join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID inner join TE_FA_J_Hospital as H on P.Hos_ID = H.Hos_ID

select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization,H.Hos_ID,H.Hos_Name,H.Hos_Phone,H.Hos_City from TE_FA_JPatient as P 
right join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID right join TE_FA_J_Hospital as H on P.Hos_ID = H.Hos_ID

--Patients Details using Left Join(Left Join)--
select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization from TE_FA_JPatient as P 
Left join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID 

--Patients,Doctor,Hospital Details using Left Join--
select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization,H.Hos_ID,H.Hos_Name,H.Hos_Phone,H.Hos_City from TE_FA_JPatient as P 
Left join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID inner join TE_FA_J_Hospital as H on P.Hos_ID = H.Hos_ID

select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization,H.Hos_ID,H.Hos_Name,H.Hos_Phone,H.Hos_City from TE_FA_JPatient as P 
Left join TE_FA_J_Doctor as D on P.Doc_ID = D.Doc_ID Left join TE_FA_J_Hospital as H on P.Hos_ID = H.Hos_ID

--Cross Join--
select P.Pat_ID,P.Pat_Name,P.Pat_Gender,P.Pat_Age,Pat_Checkups,D.Doc_ID,D.Doc_Name,D.Doc_Specialization,H.Hos_ID,H.Hos_Name,H.Hos_Phone,H.Hos_City from TE_FA_JPatient as P 
cross join TE_FA_J_Doctor as D cross join TE_FA_J_Hospital as H 
